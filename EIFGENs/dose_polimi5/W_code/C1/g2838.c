...
extern void F838_6563(EIF_REFERENCE);
...
EIF_TYPED_VALUE F838_6553 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 837, Current, 0, 1, 11792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 837, l_feature_name, 1, 838);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(tb1 == (EIF_BOOLEAN) 0)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 837, 34, 0xF8000346, 0); /* card */
...
void F838_6556 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F838_6557 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 11795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F838_6558 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 11796);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F838_6559 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 11797);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F838_6560 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 11798);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 11799);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F838_6562 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 11800);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
/* {G21_CELL}.printcell */
void F838_6563 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 837, Current, 0, 0, 11801);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(837, Current, 11801);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)ur1 = ti4_1;
	...
	RTNHOOK(4,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(838, 37, "cardname", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(837, 24, dtype))(Current, ur1x);
	RTHOOK(5);
