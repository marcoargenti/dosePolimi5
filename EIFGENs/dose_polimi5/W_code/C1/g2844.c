...
extern EIF_TYPED_VALUE F844_6759(EIF_REFERENCE);
extern EIF_TYPED_VALUE F844_6760(EIF_REFERENCE);
extern EIF_TYPED_VALUE F844_6762(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F844_7117(EIF_REFERENCE, int);
...
/* {G21_AI}.board */
EIF_TYPED_VALUE F844_6759 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(843,32, Dtype(Current)));
	return r;
}


/* {G21_AI}.cards */
EIF_TYPED_VALUE F844_6760 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(843,33, Dtype(Current)));
	return r;
}


/* {G21_AI}.equals_card */
EIF_TYPED_VALUE F844_6762 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 843, Current, 0, 2, 11964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(843, Current, 11964);
	if (arg1) {
		RTCC(arg1, 843, l_feature_name, 1, 838);
	}
	if (arg2) {
		RTCC(arg2, 843, l_feature_name, 2, 838);
	}
	RTIV(Current, RTAL);
...
/* {G21_AI}._invariant */
void F844_7117 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 843, Current, 0, 7116);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("board_valid", Current);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(843, 32, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(843, 33, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		RTCK;
	} else {
		RTCF;
